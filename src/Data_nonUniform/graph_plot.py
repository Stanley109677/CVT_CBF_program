...
path = os.getcwd()
DATA_PATH = '/home/robolab/catkin_ws3/src/coverage_control_cbf/src/Data_nonUniform'
...
def trajectories_plot(log_file_dir):
    ...
    plt.legend(loc=3, prop={'size':5}, ncol = 1, frameon=True)
    ...
    plt.savefig('/home/robolab/catkin_ws3/src/coverage_control_cbf/src/Data_nonUniform/trajectories_plot_png'+'.png')
    plt.savefig('/home/robolab/catkin_ws3/src/coverage_control_cbf/src/Data_nonUniform/trajectories_plot_eps'+'.eps', format = 'eps')
    plt.show()
