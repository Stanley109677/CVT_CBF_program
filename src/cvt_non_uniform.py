...
def gen_voronoi_first(coords, target): # As initialize
    outer = [(-5, -5), (7, -5), (7, 7), (-5, 7)] # [(-12, -12), (12, -12), (12, 12), (-12, 12)]
...
def gen_voronoi_upd(new_coords, target, ori_centroid): # In the while loop
    #outer = [(-3, -3), (6, -3), (6, 6), (-3, 6)] # [(-12, -12), (12, -12), (12, 12), (-12, 12)]
    ...
    return area_shape, poly_shapes, poly_to_pt_assignments, new_centroids, new_coords, x_unit, y_unit, poly_centroids
    #return area_shape, poly_shapes, poly_to_pt_assignments, new_centroids, new_coords, poly_centroids # static density function
...
def plotting_voronoi(fig, ax1, iter, save_fig=False):
    major_locator=MultipleLocator(3)
    ax1.set_xlim([-5,7])
    ax1.set_ylim([-5,7])

    #change x,y labels
    y_ticks = np.arange(0, 100, 4)
    ...
    if save_fig:
        plt.savefig('/home/robolab/raspi_ws/src/CVT_CBF_gazebo/Data/Safe_ad/FIG/FIG_'+str(iter)+'.png')
